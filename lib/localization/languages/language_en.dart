...
final Map<String, String> enUS = {
  EnumLocal.txtAppName.name: "NexNex",
  EnumLocal.txtSkip.name: "Skip",
  EnumLocal.txtOnBoardingTitle_1.name: "OUR MISSION",
  EnumLocal.txtOnBoardingTitle_2.name: "GLOBAL USERS",
  EnumLocal.txtOnBoardingTitle_3.name: "YOU HAVE TALENT",
  EnumLocal.txtOnBoardingSubTitle_1.name:
      "Promoting talents of millions of young people from every tribe, people and nations",
  EnumLocal.txtOnBoardingSubTitle_2.name:
      "Millions of young people are highly talented they are in obscurity, people don't know them. Our app Nexnex app will discover them. We expect to have millions of users from over 190 countries",
  EnumLocal.txtOnBoardingSubTitle_3.name:
      "Everyone on earth has a talent, gift or skills. Make a very short quality video about it. Soon, millions of people will see it globally, your gift will make a way for you.",
  EnumLocal.txtLoginTitle.name: "Let’s meet new people around you",
  EnumLocal.txtLoginSubTitle.name:
      "Welcome! Sign in quickly or use your Google account to start meeting new people around you. Let's begin your journey to new friendships!",
  ...
  EnumLocal.txtStopLiveDialogText.name:
  ...
  EnumLocal.txtLogOutText.name:
      "You are about to log out of your account. You will be redirected to the login page. Are you sure you want to continue?",
  ...
  EnumLocal.txtRechargePageSubTitle.name:
      "Upgrade to the Premium Plan for unlimited access to advanced tools and exclusive resources. Elevate your experience now.",
  EnumLocal.txtConfirmWithdrawDialogText.name:
      "Please review the withdrawal details carefully to ensure accuracy. Double-check the destination account information and the withdrawal amount to avoid any errors.",
  ...
  EnumLocal.txtWithdrawalRequestedCoinMustBeGreaterThanSpecifiedByTheAdmin.name:
      "Withdrawal requested coin must be greater than specified by the admin !!",
