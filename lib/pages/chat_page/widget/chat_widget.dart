        ...
        child: Center(
          child: Row(
            ...
            children: [
              ...
              Spacer(),
              GestureDetector(
                onTap: () => controller.showChatOptionsBottomSheet(context),
                child: Container(
                  height: 50,
                  width: 50,
                  decoration: const BoxDecoration(
...
class MessageTextFieldUi extends GetView<ChatController> {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Obx(
        () => controller.isChatDeleted.value
            ? Container(
                height: 50,
            ...
            : controller.isUserBlocked.value
                ...
                : controller.isUserReported.value
                    ? Container(
                        height: 50,
                        padding: const EdgeInsets.symmetric(horizontal: 20),
                        alignment: Alignment.center,
                        ...
                        child: Text(
                          'User has been reported. Chat is restricted.',
                          style: AppFontStyle.styleW500(
                              AppColor.colorTextGrey, 16),
                        ),
                      )
                    : Row(
                                ...
                                children: [
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      GestureDetector(
                                        onTap: () =>
                                            controller.onClickImage(context),
                                        child: Container(
                                          height: 45,
                                          width: 45,
                                          alignment: Alignment.center,
